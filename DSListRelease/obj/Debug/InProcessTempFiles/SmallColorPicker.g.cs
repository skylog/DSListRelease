...
namespace DSList.OpenSourceControls {
    ...
    public partial class SmallColorPicker : DSList.OpenSourceControls.SmallColorPicker, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        internal DSList.OpenSourceControls.SmallColorPicker ThisColorPicker;
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SmallColorPicker).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SmallColorPicker));
                objectWriter = new System.Xaml.XamlObjectWriter(schemaContext, writerSettings);
                System.Xaml.XamlServices.Transform(reader, objectWriter);
                ThisColorPicker = ((DSList.OpenSourceControls.SmallColorPicker)(objectWriter.RootNameScope.FindName("ThisColorPicker")));
            }
            finally {
                if ((xmlReader != null)) {
        ...
        private string FindResource() {
            string[] resources = typeof(SmallColorPicker).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SmallColorPicker.g.xaml") || resource.Equals("SmallColorPicker.g.xaml"))) {
                    return resource;
                }
            }
